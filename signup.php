                    ...
                    <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                        <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            <form method="post">
                                ...
                                <div class="form-floating mb-3">
                                    <input placeholder="Confirm Password" type="text" name="c_password"
                                        class="form-control" value="<?php echo @$_POST['c_password'] ?>">
                                    <label class="form-label">Confirm Password</label>
                                </div>

                                <button name="submit" type="submit" class="btn btn-primary py-3 w-100 mb-4">Sign
                                    Up</button>
